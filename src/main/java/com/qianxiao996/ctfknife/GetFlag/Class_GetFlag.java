...
public class Class_GetFlag extends Thread {
    ...
    public ArrayList<String> list_checkbox;
    ...
    public void setValue(ArrayList<String> list_checkbox,TextArea selectedTextAreaResult, Button button,String sourceText, String input_encoding,String output_encoding, String key1, String key2, String keyFlag) {
        this.list_checkbox = list_checkbox;
        textarea_result = selectedTextAreaResult;
    ...
    public void run()  {
        ...
        try {
            int current_id=1;
            int parent_id = 0;
            aa = gogogo(all_method,temp_text,current_id,parent_id,null);
...
//        return (String.join("-->", ut_result)).replace("-->\r\n-->","\r\n\r\n").replace("-->\r\n","\r\n");
    ...
    public ArrayList<Result> xunhuna_decrypt(ArrayList<HashMap> all_method , String text) {
