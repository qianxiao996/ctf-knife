...
public class Controller_Main_One {

    @FXML
    public Button button_encrypt;

    @FXML
    public Button button_decrypt;
    @FXML
    ...
    public void initialize() {
        ...
        key_encoding.getItems().addAll("UTF-8","Hex","Base64");
...
//        TextArea_Result.setText(source_text);
        ...
        if(Objects.equals(type, "encode_base")){
            ...
            myThread.setOne(key,key_encode);
