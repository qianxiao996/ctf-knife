...
import com.qianxiao996.ctfknife.Encode.Class_Decrypt;
import com.qianxiao996.ctfknife.Encode.Class_Decrypt_go;
import com.qianxiao996.ctfknife.Encode.Class_Encrypt;
import com.qianxiao996.ctfknife.Encode.Class_Tools;
...
public class Controller_Two {
    ...
    void button_click(ActionEvent event) {
        ...
        if (Objects.equals(type, "encrypt")) {
            ...
            myThread.setValue(appController.encode_decrypt_go,selectedTextArea_Result,encode_type,source_text,encoding,is_line);
            Thread t = new Thread(myThread);
            myThread.setTwo(key1,key2);
            t.setDaemon(true);
            t.start();
