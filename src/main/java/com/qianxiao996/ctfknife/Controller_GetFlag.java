...
import com.qianxiao996.ctfknife.Encode.Class_GetFlag;
...
public class Controller_GetFlag {
    ...
    void setMainController(Ctfknife_Controller appController, TextArea selectedTextArea_Result, String source_text, String encoding){
        //获取父类的对象
    ...
    void button_click(ActionEvent event) {
        ...
        ArrayList list_checkbox = new ArrayList();
...
//      调用编码解码
        ...
        myThread.setValue(list_checkbox,selectedTextArea_Result,appController.encode_getflag_go,source_text,encoding,temp_key_1,temp_key_2,key_flag);
